...
window.setInterval(function () {
    ...
    hours.style.transform = `rotate(${date.getUTCHours() / 12 * 360}deg)`;
...
window.setInterval(function () {
    ...
    hours.style.transform = `rotate(${(date.getUTCHours()-5) / 12 * 360}deg)`;
...
window.setInterval(function () {
    ...
    hours.style.transform = `rotate(${(date.getUTCHours()+8) / 12 * 360}deg)`;
